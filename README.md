...
6. After logging in, run the following command: ```bash <(curl -sL parcel.makerspace.cc) -a CC-IS -r 20-033-MakerTracker```
...
5. Run this command in the terminal prompt: ```bash <(curl -sL parcel.makerspace.cc) -a CC-IS -r 20-033-MakerTracker```
